...
The active working agent is the primary updater of the registered repository's
profile-owned project-context STATUS.md and TASKS.md, never files in the code repository.
